 ...
 *  
 *  将套接字发送超时（SO_SNDTIMEO socket选项）设置为指定的毫秒数，或者在“ms”参数为零时禁用它
 **/
 ...
 * number of milliseconds, or disable it if the 'ms' argument is zero.
 * 
 * 将套接字接收超时（SO_RCVTIMEO socket选项）设置为指定的毫秒数，或者在“ms”参数为零时禁用它
 **/
